package com.officetools.frontmattercomparisontool.services;
import com.officetools.frontmattercomparisontool.models.PageBlock;
import com.officetools.frontmattercomparisontool.models.SubSubTopic;
import com.officetools.frontmattercomparisontool.models.SubTopic;
...
public class FrontMatterComparisonService {
    public Optional<ArrayList<String>> getRevisionChangesInToc(Optional<List<String>> OldLines, Optional<List<String>> newLines) throws IOException {
        ...
        Optional<ArrayList<String>> output = compareOldAndNewToc(oldPageBlockArrayList.get(), newPageBlockArrayList.get());
        return output;
    }
...
public  Optional<List<String>> readPDF(MultipartFile multipartFile) throws IOException {
